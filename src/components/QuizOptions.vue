<template>
    <main>
        ...
        <ul class="w-full gap-6">
            ...
            <li class="mb-2">
                <input type="checkbox" id="two-option" value="" class="hidden peer">
                <label for="two-option"
                    class="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-purple-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <div class="block">
            ...
            <li class="mb-2">
                <input type="checkbox" id="three-option" value="" class="hidden peer">
                <label for="three-option"
                    class="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-purple-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <div class="block">
        ...
        <button @click="changeCol" class="bg-purple-600 rounded mx-auto my-6  text-white py-2 px-3">Next</button>
