                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700" v-for="(transaction, index) in walletData" :key="index">
                                    <th scope="row"
...
export default {
  ...
  created() {
    // Fetch wallet data when the component is created
    this.fetchWalletData();
  },
  methods: {
    ...mapActions(['fetchWalletData'])
  }
};
</script>