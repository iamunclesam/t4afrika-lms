                ...
                <div class="p-4 sm:ml-72 mt-20 sm:mx-5">
                    ...
                    <div class="md:grid md:grid-cols-3  md:gap-6 ">
                        <div class="md:col-span-2 ">
                            ...
                            <section class="dark:bg-gray-900 ">
                                <div class="mx-auto max-w-screen-xl lg:px-0">
                                    <!-- Start coding here -->
                                    <div
                                        class="bg-white dark:bg-gray-800 relative md:shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="hidden md:block col fixed right-10 w-1/5">
                            ...
                            <div class="border  rounded-lg w-full shadow bg-white h-80 w-100 p-4 mt-0">
                                ...
                                <div class="justify-center h-auto items-center ">
                                    <h1 class="text-6xl font-bold text-black py-4">N500<span class="text-sm">/wk</span>
                                    </h1>
    ...
    methods: {
        setContainerHeight() {
            ...
            if (container) {
                ...
                container.style.height = height; // Set height dynamically
            }
        }
    }
}
